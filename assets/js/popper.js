...
(function(e, t) {
	...
	function l(e) {
		...
		void 0 !== arguments[1] ? arguments[1] : 'top', o = 'top' === t ? 'scrollTop' : 'scrollLeft', n = e.nodeName;
		if ('BODY' === n || 'HTML' === n) {
	...
	function f(e, t) {
		...
		void 0 !== arguments[2] && arguments[2], n = l(t, 'top'), i = l(t, 'left'), r = o ? -1 : 1;
	...
	function b(e, o) {
		...
		void 0 !== arguments[2] && arguments[2], p = r(10), s = 'HTML' === o.nodeName, d = u(e), a = u(o), l = n(e), m = t(o), h = parseFloat(m.borderTopWidth, 10), c = parseFloat(m.borderLeftWidth, 10);
	...
	function y(e) {
		var t = 1 < arguments.length &&
		void 0 !== arguments[1] && arguments[1], o = e.ownerDocument.documentElement, n = b(e, o), i = $(o.clientWidth, window.innerWidth || 0), r = $(o.clientHeight, window.innerHeight || 0), p = t ? 0 : l(o), s = t ? 0 : l(o, 'left'), d = {
	...
	function v(e, t, i, r) {
		...
		void 0 !== arguments[4] && arguments[4], s = {
			top : 0,
			left : 0
		}, d = p ? E(e) : a(e, t);
		if ('viewport' === r)
	...
	function L(e, t, o) {
		...
		void 0 !== arguments[3] ? arguments[3] : null, i = n ? E(t) : a(t, o);
		return b(o, i, n)
	}
	...
	function P(t, o, n) {
		var i =
		void 0 === n ? t : t.slice(0, N(t, 'name', n));
	...
	function z(e) {
		var t = 1 < arguments.length &&
		void 0 !== arguments[1] && arguments[1], o = me.indexOf(e), n = me.slice(o + 1).concat(me.slice(0, o));
	...
	function(e) {
		...
		function t(o, n) {
			var i = this, r = 2 < arguments.length &&
		...
		modifiers : {
			...
			computeStyle : {
				...
				fn : function(e, t) {
					...
					var s, d, a =
					void 0 === r ? t.gpuAcceleration : r, l = p(e.instance.popper), f = u(l), m = {
						position : i.position
					}, h = {
						left : Z(i.left),
						top : Q(i.top),
